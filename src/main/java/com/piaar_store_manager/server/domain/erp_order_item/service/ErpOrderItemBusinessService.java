    ...
    public List<ErpOrderItemVo.ExcelVo> excelSheetToPiaarVos(ExcelTranslatorHeaderGetDto translatorGetDto, Sheet sheet) {
        ...
        for(int i = 0; i < sheet.getPhysicalNumberOfRows(); i++) {
            ...
            ErpOrderItemVo.ExcelVo excelVo = ErpOrderItemVo.ExcelVo.builder()
                ...
                .releaseOptionCode(getTranslatorTargetCellValue(row, details.get(24), evaluator))
                .channelOrderDate(getTranslatorTargetCellValue(row, details.get(25), evaluator))
                .managementMemo1(getTranslatorTargetCellValue(row, details.get(26), evaluator))
                .managementMemo2(getTranslatorTargetCellValue(row, details.get(27), evaluator))
                .managementMemo3(getTranslatorTargetCellValue(row, details.get(28), evaluator))
                .managementMemo4(getTranslatorTargetCellValue(row, details.get(29), evaluator))
                .managementMemo5(getTranslatorTargetCellValue(row, details.get(30), evaluator))
                .managementMemo6(getTranslatorTargetCellValue(row, details.get(31), evaluator))
                .managementMemo7(getTranslatorTargetCellValue(row, details.get(32), evaluator))
                .managementMemo8(getTranslatorTargetCellValue(row, details.get(33), evaluator))
                .managementMemo9(getTranslatorTargetCellValue(row, details.get(34), evaluator))
                .managementMemo10(getTranslatorTargetCellValue(row, details.get(35), evaluator))
                .freightCode(null)
                .build();
