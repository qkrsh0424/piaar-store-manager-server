...
//
//            String priceStr = (row.getCell(19) == null || String.valueOf(row.getCell(19)).isEmpty()) ? "0" : (row.getCell(19).getCellType().equals(CellType.NUMERIC) ?
//                    Integer.toString((int) row.getCell(19).getNumericCellValue()) : row.getCell(19).getStringCellValue());
//
//            String deliveryChargeStr = (row.getCell(20) == null || String.valueOf(row.getCell(20)).isEmpty()) ? "0" : (row.getCell(20).getCellType().equals(CellType.NUMERIC) ?
//                    Integer.toString((int) row.getCell(20).getNumericCellValue()) : row.getCell(20).getStringCellValue());
//
//            // '출고 옵션코드' 값이 입력되지 않았다면 '피아르 옵션코드'로 대체한다
//            String releaseOptionCode = (row.getCell(24) != null) ? row.getCell(24).getStringCellValue() : (row.getCell(23) == null ? "" : row.getCell(23).getStringCellValue());
//
...
//                    .destinationDetail(row.getCell(8) != null ? row.getCell(8).getStringCellValue() : "")
//                    .salesChannel(row.getCell(9) != null ? row.getCell(9).getStringCellValue() : "")
//                    .orderNumber1(row.getCell(10) != null ? row.getCell(10).getStringCellValue() : "")
//                    .orderNumber2(row.getCell(11) != null ? row.getCell(11).getStringCellValue() : "")
//                    .channelProdCode(row.getCell(12) != null ? row.getCell(12).getStringCellValue() : "")
//                    .channelOptionCode(row.getCell(13) != null ? row.getCell(13).getStringCellValue() : "")
//                    .zipCode(row.getCell(14) != null ? row.getCell(14).getStringCellValue() : "")
//                    .courier(row.getCell(15) != null ? row.getCell(15).getStringCellValue() : "")
//                    .transportType(row.getCell(16) != null ? row.getCell(16).getStringCellValue() : "")
//                    .deliveryMessage(row.getCell(17) != null ? row.getCell(17).getStringCellValue() : "")
//                    .waybillNumber(row.getCell(18) != null ? row.getCell(18).getStringCellValue() : "")
//                    .price(priceStr)
//                    .deliveryCharge(deliveryChargeStr)
//                    .barcode(row.getCell(21) != null ? row.getCell(21).getStringCellValue() : "")
//                    .prodCode(row.getCell(22) != null ? row.getCell(22).getStringCellValue() : "")
//                    .optionCode(row.getCell(23) != null ? row.getCell(23).getStringCellValue() : "")
