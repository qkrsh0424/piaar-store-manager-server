...
@Data
public class PackingListNaverExcelFormDto implements Comparable<PackingListNaverExcelFormDto>{
    private String prodOrderNo; // 상품주문번호 1
    private String orderNo; // 주문번호 2
    ...
    @Override
    public int compareTo(PackingListNaverExcelFormDto data){
