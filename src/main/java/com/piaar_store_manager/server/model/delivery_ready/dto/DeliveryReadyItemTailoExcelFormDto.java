...
public class DeliveryReadyItemTailoExcelFormDto {
    ...
    public static DeliveryReadyItemTailoExcelFormDto toTailoFormDto(DeliveryReadyItemViewDto viewDto) {
        ...
        DeliveryReadyItemTailoExcelFormDto formDto = DeliveryReadyItemTailoExcelFormDto.builder()
                ...
                .transportType("택배")
                .buyer(viewDto.getDeliveryReadyNaverItem().getBuyer())
                ...
                .receiverContact2(viewDto.getDeliveryReadyNaverItem().getReceiverContact2())
                .zipCode(viewDto.getDeliveryReadyNaverItem().getZipCode())
                .destination1(viewDto.getDeliveryReadyNaverItem().getDestination())
                .destination2("")
                ...
                .managementMemo1(viewDto.getDeliveryReadyNaverItem().getOptionManagementCode())
                .managementMemo2(viewDto.getDeliveryReadyNaverItem().getProdOrderNumber())
                .managementMemo3("")
                .managementMemo4("")
                .managementMemo5("")
                .prodMemo1(viewDto.getDeliveryReadyNaverItem().getProdName())
                .prodMemo2(viewDto.getDeliveryReadyNaverItem().getOptionInfo())
                .prodMemo3("")
                .orderType("")
                .releaseDesiredDate("")
                .build();
